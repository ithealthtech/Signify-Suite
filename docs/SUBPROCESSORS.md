...
| Resend, when configured                          | Account verification, invitation, and recovery email | Recipient, subject, message content                 | DPA, region, verified domain, suppression handling |
